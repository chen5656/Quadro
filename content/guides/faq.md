...
Yes. QUADRO is forever free to play. There is no paid tier, no ads, and no in-game purchase.
...
One recorded attempt per opponent per day. Because each of the six AI opponents has its own board, you can hold a place on several boards on the same day — but you cannot replay the same opponent for a better number. [Practice](/practice) is unlimited and never recorded.
...
Yes. Practice runs entirely in your browser — the AI engine included — so once the page has loaded it keeps working with no network. QUADRO is installable as a PWA app on mobile and desktop. The Daily needs a network connection to fetch the seed and record scores.

## Is this the board game Azul?

No. QUADRO is an original browser-based strategic duel inspired by classic drafting mechanics and reimagined through the narrative of AI consciousness and memory. Read more in [Games like Azul](/guide/games-like-azul).

## Does the AI cheat?

No. It sees exactly what you see. QUADRO is a game of complete information — no hidden hands, no hidden bag order — so there is nothing for either side to hide. The AI's strength comes purely from algorithmic search depth and tree simulations.
