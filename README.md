...
- **Inspiring Cinematic Music** by [Tunetank](https://pixabay.com/music/main-title-inspiring-cinematic-music-409347/) — Pixabay Content License (`public/audio/music/daily.mp3`).
...
See [docs/audio.md](docs/audio.md) for the full audio design.
